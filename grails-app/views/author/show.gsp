	...
	<body>
		...
		<div id="show-author" class="content scaffold-show" role="main">
			...
			<ol class="property-list author">
				...
				<g:if test="${authorInstance?.surname}">
				<li class="fieldcontain">
					<span id="surname-label" class="property-label"><g:message code="author.surname.label" default="Surname" /></span>
					
						<span class="property-value" aria-labelledby="surname-label"><g:fieldValue bean="${authorInstance}" field="surname"/></span>
